...
from utils.utils_head import non_max_suppression, bbox_iou, DecodeBox, letterbox_image, yolo_correct_boxes
...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        # print(output.size()) # ([1, 10647, 25])
        batch_detections = non_max_suppression(output, 20,
                                               conf_thres=0.5,
                                               nms_thres=0.3)
